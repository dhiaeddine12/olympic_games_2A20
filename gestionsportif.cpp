...
Gestionsportif::Gestionsportif(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::Gestionsportif)
{
    login_bd l;
     Connection c;
       l.fermerConnexion1();
...
Gestionsportif::~Gestionsportif()
{
    delete ui;
}


void Gestionsportif::on_pb_ajouter_clicked()
{
...
void Gestionsportif::on_pb_supprimer_clicked()
{
    sportifs s1;
...
void Gestionsportif::on_pb_modifier_clicked()
{
...
void Gestionsportif::on_pb_rechercher_clicked()
{
     sportifs s;
...
void Gestionsportif::on_pb_rechercher_id_clicked()
{
    sportifs s;
...
void Gestionsportif::on_pb_rechercher_type_sport_clicked()
{
    sportifs s;
...
void Gestionsportif::on_pb_trier_n_clicked()
{
    QMessageBox msgBox ;
...
void Gestionsportif::on_pb_trier_i_clicked()
{
    QMessageBox msgBox ;
...
void Gestionsportif::on_pb_trier_a_clicked()
{
    QMessageBox msgBox ;
...
void Gestionsportif::on_pb_update_clicked()
{
    QSqlQueryModel* model=new QSqlQueryModel();
...
void Gestionsportif::on_pb_print_clicked()
{
...
void Gestionsportif::on_pb_sommee_clicked()
{
