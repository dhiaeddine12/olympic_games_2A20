...
void gestionemploye::on_Pb_image_clicked()
{
...
void gestionemploye::on_Pb_recherche_nom_clicked()
{
Employe E;
...
void gestionemploye::on_Pb_recherche_fonction_clicked()
{
Employe E;
...
void gestionemploye::on_Pb_recherche_identifiant_clicked()
{
Employe E;
...
void gestionemploye::on_Pb_trier_age_clicked()
{
QMessageBox msgBox;
...
void gestionemploye::on_Pb_trier_annee_de_recrutement_clicked()
{
QMessageBox msgBox;
QSqlQueryModel *model = new QSqlQueryModel();
...
void gestionemploye::on_Pb_trier_sexe_clicked()
{
QMessageBox msgBox;
QSqlQueryModel *model = new QSqlQueryModel();
...
void gestionemploye::on_Pb_stat_absence_clicked()
{
...
void gestionemploye::on_Pb_stat_heure_de_travail_clicked()
{
QSqlQueryModel * model= new QSqlQueryModel();
...
void gestionemploye::on_Pb_stat_age_clicked()
{
QSqlQueryModel * model= new QSqlQueryModel();
...
void gestionemploye::on_Pb_mise_a_jour_clicked()
{
QSqlQueryModel* model=new QSqlQueryModel();
