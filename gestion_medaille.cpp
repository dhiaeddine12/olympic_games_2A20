...
void gestion_medaille::on_trier_currentIndexChanged(const QString &arg1)
{
        QString crit=ui->trier->currentText();
        if(crit=="id")
        {
...
void gestion_medaille::on_lineedit_rech_clicked()
{
